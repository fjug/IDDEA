...
{
	private final SpimDrawingView viewer;
	...
	public CropDialog( final Window owner, final SpimDrawingView viewer, final SequenceDescription sequenceDescription )
	{
		super( owner, "crop and save", Dialog.ModalityType.MODELESS );
		this.viewer = viewer;
