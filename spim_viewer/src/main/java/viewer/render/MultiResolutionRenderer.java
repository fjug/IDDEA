...
public class MultiResolutionRenderer
{
	 ...
	 *            How many threads to use for rendering.
	 */
	public MultiResolutionRenderer( final SpimDrawingView display, final PainterThread painterThread, final double[] screenScales, final long targetRenderNanos, final long targetIoNanos, final int badIoFrameBlockFrames, final boolean doubleBuffered, final int numRenderingThreads )
	{
...
//			maxMipmapLevel[ i ] = numMipmapLevels[ i ] - 1;
	...
	public MultiResolutionRenderer( final SpimDrawingView display, final PainterThread painterThread, final double[] screenScales )
	{
	...
	{
		final int componentW = display.getContentWidth();
		final int componentH = display.getContentHeight();
