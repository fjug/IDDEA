 ...
 * @version $Id: OSXApplication.java 780 2012-10-25 05:15:43Z rawcoder $
 */
public class OSXApplication extends AbstractApplication {
    ...
    public void show(View view) {
        if (!view.isShowing()) {
            ...
            final GraphicsConfiguration gc = getSuitableGraphicsConfiguration( net.imglib2.display.ARGBScreenImage.ARGB_COLOR_MODEL );
